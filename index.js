...
function renderAll() {
    renderComments({
        ...
        textarea,
        showQuoteBlock,
        attachLikeListeners: () => attachLikeListeners({commentsList, textarea, showQuoteBlock, attachLikeListeners, attachCommentReply}),
        attachCommentReply: () => attachCommentReply({textarea, showQuoteBlock}),
    });
}
